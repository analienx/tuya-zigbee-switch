...
#define ELEC_MEAS_CAL_NV_MAGIC    0x484C5743u
...
static void elec_meas_apply_calibration_values(
    ...
    energy_meter_set_calibration(cluster->meter, mults[0], mults[1],
                                 mults[2]);
...
static void elec_meas_overload_save(
    electrical_measurement_cluster_t *cluster) {
...
void electrical_measurement_cluster_add_to_endpoint(
    ...
    SETUP_ATTR(0, ZCL_ATTR_ELEC_MEAS_MEASUREMENT_TYPE,
               ZCL_DATA_TYPE_BITMAP32, ATTR_READONLY,
               cluster->measurement_type);
    SETUP_ATTR(1, ZCL_ATTR_ELEC_MEAS_RMS_VOLTAGE,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY, cluster->rms_voltage);
    SETUP_ATTR(2, ZCL_ATTR_ELEC_MEAS_RMS_CURRENT,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY, cluster->rms_current);
    SETUP_ATTR(3, ZCL_ATTR_ELEC_MEAS_ACTIVE_POWER,
               ZCL_DATA_TYPE_INT16, ATTR_READONLY, cluster->active_power);
    SETUP_ATTR(4, ZCL_ATTR_ELEC_MEAS_AC_VOLTAGE_MULTIPLIER,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->ac_voltage_multiplier);
    SETUP_ATTR(5, ZCL_ATTR_ELEC_MEAS_AC_VOLTAGE_DIVISOR,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->ac_voltage_divisor);
    SETUP_ATTR(6, ZCL_ATTR_ELEC_MEAS_AC_CURRENT_MULTIPLIER,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->ac_current_multiplier);
    SETUP_ATTR(7, ZCL_ATTR_ELEC_MEAS_AC_CURRENT_DIVISOR,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->ac_current_divisor);
    SETUP_ATTR(8, ZCL_ATTR_ELEC_MEAS_AC_POWER_MULTIPLIER,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->ac_power_multiplier);
    SETUP_ATTR(9, ZCL_ATTR_ELEC_MEAS_AC_POWER_DIVISOR,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->ac_power_divisor);
    SETUP_ATTR(10, ZCL_ATTR_ELEC_MEAS_CUST_FREQUENCY_CF,
               ZCL_DATA_TYPE_UINT32, ATTR_READONLY, cluster->freq_cf);
    SETUP_ATTR(11, ZCL_ATTR_ELEC_MEAS_CUST_FREQUENCY_CF1,
               ZCL_DATA_TYPE_UINT32, ATTR_READONLY, cluster->freq_cf1);
    SETUP_ATTR(12, ZCL_ATTR_ELEC_MEAS_CUST_FREQUENCY_SEL_STATE,
               ZCL_DATA_TYPE_UINT8, ATTR_READONLY, cluster->sel_state);
    SETUP_ATTR(13, ZCL_ATTR_ELEC_MEAS_CUST_CALIBRATE_VOLTAGE,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->calibrate_voltage);
    SETUP_ATTR(14, ZCL_ATTR_ELEC_MEAS_CUST_CALIBRATE_CURRENT,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->calibrate_current);
    SETUP_ATTR(15, ZCL_ATTR_ELEC_MEAS_CUST_CALIBRATE_POWER,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
    ...
    SETUP_ATTR(18, ZCL_ATTR_ELEC_MEAS_CUST_OVERLOAD_CURRENT_LIMIT,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->overload_current_limit);
    SETUP_ATTR(19, ZCL_ATTR_ELEC_MEAS_CUST_OVERLOAD_TRIP_DELAY,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->overload_trip_delay);
    SETUP_ATTR(20, ZCL_ATTR_ELEC_MEAS_CUST_OVERVOLTAGE_WARN,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->overvoltage_warn);
    SETUP_ATTR(21, ZCL_ATTR_ELEC_MEAS_CUST_UNDERVOLTAGE_WARN,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->undervoltage_warn);
    SETUP_ATTR(22, ZCL_ATTR_ELEC_MEAS_CUST_OVERLOAD_RECONNECT_DELAY,
               ZCL_DATA_TYPE_UINT16, ATTR_WRITABLE,
               cluster->overload_reconnect_delay);
    SETUP_ATTR(23, ZCL_ATTR_ELEC_MEAS_CUST_OVERLOAD_ALARM,
               ZCL_DATA_TYPE_ENUM8, ATTR_READONLY,
               cluster->overload_alarm);
    SETUP_ATTR(24, ZCL_ATTR_ELEC_MEAS_APPARENT_POWER,
               ZCL_DATA_TYPE_UINT16, ATTR_READONLY,
               cluster->apparent_power);
    SETUP_ATTR(25, ZCL_ATTR_ELEC_MEAS_REACTIVE_POWER,
               ZCL_DATA_TYPE_INT16, ATTR_READONLY,
               cluster->reactive_power);
    SETUP_ATTR(26, ZCL_ATTR_ELEC_MEAS_POWER_FACTOR,
               ZCL_DATA_TYPE_INT8, ATTR_READONLY,
               cluster->power_factor);
...
void electrical_measurement_cluster_load_calibration(
    ...
    if (hal_nvm_read(NV_ITEM_ENERGY_CALIBRATION, sizeof(nv), (uint8_t *)&nv) !=
        HAL_NVM_SUCCESS || nv.magic != ELEC_MEAS_CAL_NV_MAGIC) {
        return;
    }
    ...
    printf("ElecMeas: restored calibration V=%u A=%u W=%u\r\n",
           nv.voltage_multiplier, nv.current_multiplier,
           nv.power_multiplier);
}
