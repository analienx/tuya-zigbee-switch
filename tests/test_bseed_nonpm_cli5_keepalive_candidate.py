...
def test_candidate_is_opt_in_and_has_distinct_ota_version():
    ...
    assert "SW_BUILD='1.1.2-bseedcli5-rc1'" in candidate
    assert "FILE_VERSION_HEX='0x11023010'" in candidate
    assert 'FILE_VERSION_DEC=285356048' in candidate
...
def test_candidate_keeps_router_and_pm_images_separate():
    ...
    assert "DEFAULT_OUT='build/bseed-ts011f-nonpm-client-cli5-rc1'" in candidate
