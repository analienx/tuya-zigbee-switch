...
async function main() {
    ...
    if (!input) die('usage: probe_bseed_ts0726_v6_endpoint_routing.js <overlay.js>');
    ...
    const cases = [
        ...
        ['switch_left_action_mode', 'Match local state', 1, 'genOnOffSwitchCfg', 0xff06, 3],
        ['switch_middle_action_mode', 'Match local state', 2, 'genOnOffSwitchCfg', 0xff06, 3],
        ['switch_right_action_mode', 'Toggle', 3, 'genOnOffSwitchCfg', 0xff06, 2],
    ...
    const middleAction = runFz('genOnOffSwitchCfg', 2, {65286: 3});
