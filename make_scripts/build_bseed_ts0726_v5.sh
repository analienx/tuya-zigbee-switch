...
FORWARD_SW_BUILD='1.1.5-bseedv5'
FORWARD_FILE_VERSION='0x11023005'   # decimal 285356037
RECOVERY_SW_BUILD='1.1.5-bseedv5r'
RECOVERY_FILE_VERSION='0x11023006'  # decimal 285356038

OUT_DIR="${1:-build/bseed-ts0726-v5}"
mkdir -p "$OUT_DIR"
