...
/**
 * BSEED TS0726-3-BS v6 clean-binding overlay.
 *
 * Deployment:
 *   - keep the exact historical fleet converter (ef79...) unchanged;
 *   - load this file beside it;
 *   - this definition wins only for forward firmware 1.1.6-bseedv6.
 *
...
const buttonCommandBehavior = (name, endpointName) =>
    pinnedEnum({
        ...
        cluster: "genOnOffSwitchCfg",
        // v6 keeps standard switchActions/0x0010 within Zigbee's 0..2
        // domain and carries the extended binding policy in custom 0xff06.
        attribute: {ID: 0xff06, type: 0x30},
