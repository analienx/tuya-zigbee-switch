...
Status checked on 2026-09-19. **Router goldens are released; Mains Client remains a canary and must not be advertised as a normal OTA update.** The word *golden* here means an exact, retained, hardware-accepted image for a specific board and role—not a guarantee of perfect reliability.

| Socket board | Released Router | Router OTA image type | Client candidate | Client OTA image type | Client hardware status |
|---|---|---:|---|---:|---|
| TS011F-BS-PM (`b28wrpvx`) | `1.2.5-bseedv8u4`, `0x12053007` | `43556` | `1.2.5-bseedcli4`, `0x1205300A` | `65024` | **Not accepted**; PM Client canary required |
